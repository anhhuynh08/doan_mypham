...
class CategoryProduct extends Controller
{
    ...
    public function save_category_product (Request $request){
        ...
        if($request->category_product_name==null||$request->category_product_name==""||$request->category_product_desc==null||$request->category_product_desc==""||$request->category_product_status==null||$request->category_product_status==""){
            return Redirect::to('add-category-product')->with('error','vui lòng nhập đầy đủ thông tin để thêm danh mục');
        }else{
