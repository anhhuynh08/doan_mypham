...
Smartphone Compatible web template, free webdesigns for Nokia, Samsung, LG, SonyEricsson, Motorola web design" />
    ...
    <link href="{{asset('public/backend/css/style-responsive.css')}}" rel='stylesheet' type='text/css' />
    <!-- font CSS -->
...
$(document).ready(function(){
  $('.add_brand').click(function(){
    if(brand_product_name==null||brand_product_name==""){
            ...
            <ul class="nav pull-right top-menu">
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu extended logout">
                        <li><a href="{{URL::to('/update-pass-admin/'.$admin_id)}}"><i class="fa fa-refresh"></i> Đổi mật khẩu</a></li>
                        <li><a href="{{URL::to('/logout')}}"><i class="fa fa-sign-out" aria-hidden="true"></i> Đăng xuất</a></li>
                        <?php
                            ...
                            ?></br>
                         <li><a href="{{URL::to('/add-admin')}}"><i class="fa fa-user-plus"></i> Quản lý người dùng</a></li>
                        <?php   
                            }
                        ?>
                    </ul>
            ...
            <div class="leftside-navigation">
                <ul class="sidebar-menu" id="nav-accordion">
                    ...
                    <li class="sub-menu">
                        ...
                        <ul class="sub">
                            <li><a href="{{URL::to('/manage-targetup')}}">Sản phẩm bán chạy</a></li>
                            <li><a href="{{URL::to('/target-month')}}">Doanh thu theo tháng</a></li>
                            <li><a href="{{URL::to('/manage-target')}}">Sản phẩm tồn kho</a></li>
                        </ul>
                    </li>
                    <li class="sub-menu">
                        <a href="javascript:;">
                        ...
                        <ul class="sub">
                            ...
                            <li><a href="{{URL::to('/uu-tien')}}">Đơn hàng ưu tiên</a></li>
                        </ul>
                    </li>
                    <li class="sub-menu">
                        <a href="javascript:;">
                    ...
                    <li class="sub-menu">
                        ...
                        <ul class="sub">
                            <li><a href="{{URL::to('/customer-info')}}">Thông tin khách hàng</a></li>
